...
import { signUp } from '@/app/services/index';
...
const Signup = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const { userSignUp } = await signUp(firstName, lastName, userName, phone, email, password, profilePicUrl);
      resetForm();
      setProfilePic(null);
      setCookie('token', userSignUp.token, 1);
